...
@interface HcdMovieGLRenderer_RGB : NSObject<HcdMovieGLRenderer> {
...
@interface HcdMovieGLRenderer_YUV : NSObject<HcdMovieGLRenderer> {
             ...
             decoder: (HcdMovieDecoder *) decoder
{
    ...
    if (self) {
        ...
        if ([decoder setupVideoFrameFormat:HcdVideoFrameFormatYUV]) {
            
            _renderer = [[HcdMovieGLRenderer_YUV alloc] init];
            LoggerVideo(1, @"OK use YUV GL renderer");
            
        } else {
            
            _renderer = [[HcdMovieGLRenderer_RGB alloc] init];
