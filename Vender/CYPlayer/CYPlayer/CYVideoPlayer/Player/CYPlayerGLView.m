...
- (BOOL)loadShaders
{
    ...
    NSString *fragmentShaderResource = _decoder.isYUV ? @"HCDPlayerYUVFragmentShader" : @"HCDPlayerRGBFragmentShader";
    NSString *fragmentShaderFile = [bundle pathForResource:fragmentShaderResource ofType:@"glsl"];
    fragShader = [CYPlayerGLView loadShader:GL_FRAGMENT_SHADER withFile:fragmentShaderFile];
