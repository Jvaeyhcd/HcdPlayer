...
@protocol CDMovieGLRenderer <NSObject>

- (BOOL)isValid;
- (NSString *)fragmentShader;
- (void)resolveUniforms:(GLuint)program;
- (void)setFrame:(CDVideoFrame *)frame;
- (BOOL)prepareRender;

@end

@interface CDMovieGLRenderer_RGB : NSObject<CDMovieGLRenderer> {
...
@implementation CDMovieGLRenderer_RGB
...
@interface CDMovieGLRenderer_YUV : NSObject<CDMovieGLRenderer> {
...
@implementation CDMovieGLRenderer_YUV
...
- (void)setFrame:(CDVideoFrame *)frame {
    ...
    CDVideoFrameYUV *yuvFrame = (CDVideoFrameYUV *)frame;
...
@implementation CDMovieGLView {
    ...
    id<CDMovieGLRenderer> _renderer;
}
...
- (id)initWithFrame:(CGRect)frame decoder:(CDPlayerDecoder *)decoder {
    ...
    if (self) {
        ...
        if ([decoder setupVideoFrameFormat:CDVideoFrameFormatYUV]) {
            
            _renderer = [[CDMovieGLRenderer_YUV alloc] init];
//            LoggerVideo(1, @"OK use YUV GL renderer");
            
        } else {
            
            _renderer = [[CDMovieGLRenderer_RGB alloc] init];
