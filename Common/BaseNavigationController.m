...
- (void)viewDidLoad {
    ...
    [UINavigationBar appearance].titleTextAttributes = @{NSFontAttributeName: [UIFont boldSystemFontOfSize:18], NSForegroundColorAttributeName: [UIColor colorWithRGBHex:0xFFFFFF]};
}
...
- (void)hideBottomBorderInView: (UIView *)view {
    if ([view isKindOfClass:[UIImageView class]] && view.frame.size.height <= 1.0) {
        [view setHidden:YES];
        [view setBackgroundColor: kNavBgColor];
    }
